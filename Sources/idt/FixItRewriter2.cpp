//===- FixItRewriter2.cpp - Fix-It Rewriter Diagnostic Client --------------===//
//
...
FixItRewriter2::FixItRewriter2(DiagnosticsEngine &Diags, SourceManager &SourceMgr,
...
FixItRewriter2::~FixItRewriter2() {
  Diags.setClient(Client, Owner.release() != nullptr);
}

bool FixItRewriter2::WriteFixedFile(FileID ID, raw_ostream &OS) {
...
bool FixItRewriter2::WriteFixedFiles(
...
bool FixItRewriter2::IncludeInDiagnosticCounts() const {
  return Client ? Client->IncludeInDiagnosticCounts() : true;
}

void FixItRewriter2::HandleDiagnostic(DiagnosticsEngine::Level DiagLevel,
...
void FixItRewriter2::Diag(SourceLocation Loc, unsigned DiagID) {
...
void FixItRewriter2::ProcessRewrites() {
  RewritesReceiver Rec(Rewrite);
  Editor.applyRewrites(Rec);
}
